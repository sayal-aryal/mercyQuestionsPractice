...
public class pairedN {
    ...
    public static void main(String[] args) {
        System.out.println("isPairedN: " + isPairedN(new int[]{1, 4, 1, 4, 5, 6}, 5)); // return 1
        System.out.println("isPairedN: " + isPairedN(new int[]{1, 4, 1, 4, 5, 6}, 6)); // return 1
        System.out.println("isPairedN: " + isPairedN(new int[]{0, 1, 2, 3, 4, 5, 6, 7, 8}, 6)); // return 1
        System.out.println("isPairedN: " + isPairedN(new int[]{1, 4, 1}, 5));// return 0
        System.out.println("isPairedN: " + isPairedN(new int[]{8, 8, 8, 8, 7, 7, 7}, 15));// return 0
        System.out.println("isPairedN: " + isPairedN(new int[]{8, -8, 8, 8, 7, 7, -7}, -15));// return 0
        System.out.println("isPairedN: " + isPairedN(new int[]{3}, 3));// return 0
        System.out.println("isPairedN: " + isPairedN(new int[]{}, 0));// return 0
    }
    ...
    public static int isPairedN(int[] a, int n) {
        ...
        for (int i = 0; i < a.length; i++) {
            for (int j = i + 1; j < a.length; j++) {
                if (a[i] + a[j] == n && Math.abs(i) + Math.abs(j) == n) {
                    return 1;
                }
            }
        }
